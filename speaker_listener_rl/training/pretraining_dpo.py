...
from speaker_listener_rl.data import dataloader
...
def pre_training(
        output_dir,
        text_dataset=None,
        input = "speaker_listener_rl/data/train_100m_passages.jsonl",
        model_name="gpt2",
        block_size=128,
        batch_size=16,
        lr=1e-4,
...
def parse_args():
    ...
    parser.add_argument("--train_jsonl", type=str, default="speaker_listener_rl/data/train_100m_passages.jsonl")
...
def main():
    ...
    wiki_text = TextOnlyDataset(SimpleWikiPassageLoader(path="speaker_listener_rl/data/simple_wiki_passages.jsonl", limit=None))
